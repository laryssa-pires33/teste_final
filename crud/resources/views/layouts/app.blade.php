...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/sabor_brasil.css') }}">
</head>
<body>
  <div class="container">

    <div class="coluna perfil">
      <img src="imagem/logo_sabor_do_brasil (1).png" alt="Logo Sabor do Brasil" class="logo">
        ...
        <div class="rodape-publicacao">
          ...
          <div class="lado-direito">
            ...
            <div class="comentarios">
              <img src="imagem/chat.svg" alt="Comentários" class="icone">
...
<!-- 2 -->
      <div class="card-publicacao">
        ...
        <img src="imagem/publicacao02.png" alt="Cuscuz Paulista" class="imagem-prato">
...
<!--    3 -->
      <div class="card-publicacao">
        ...
        <img src="imagem/publicacao03.png" alt="Frango com cubos de batata" class="imagem-prato">
